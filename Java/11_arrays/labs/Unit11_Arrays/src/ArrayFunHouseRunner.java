...
public class ArrayFunHouseRunner
{
	public static void main( String args[] )
	{
		...
		System.out.println("after removing all 7s " + Arrays.toString(ArrayFunHouse.removeVal(one, 7)));
		System.out.println("# of 7s  =  " + ArrayFunHouse.getCount(one,7));
		...
		System.out.println("after removing all 7s " + Arrays.toString(ArrayFunHouse.removeVal(two, 7)));
